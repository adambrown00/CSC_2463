...
function draw() {
  ...
  //WASD traditional keyboard input which handles each character (only used A & D for left & right)
  handleCharacterInput(roundBoy1, 'a', 'd');
  handleCharacterInput(roundBoy2, 'a', 'd');
  handleCharacterInput(roundBoy3, 'a', 'd');
...
function handleCharacterInput(character, leftKey, rightKey) {
